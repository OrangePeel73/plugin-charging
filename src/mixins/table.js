 ...
 * @param {String} tOrder order direaction
 */
    ...
    watch: {
      ...
      tKeyword(tKeyword = '', old) {
        ...
        if (tKeyword !== '') {
          ...
          const defaulHandler = x => {
            return (x[this.tField] || '').toLowerCase().includes(keyword);
          };
          // const handler = curry(this.tKeywordHandler || defaulHandler)(keyword);
          const handler = this.tKeywordHandler || defaulHandler;
